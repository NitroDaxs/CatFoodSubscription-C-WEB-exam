        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgPath = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Path for subscriptionBox image"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identification for the customer")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FirstName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "First name of the customer"),
                    LastName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "Last name of the customer"),
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Identification for the user")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identification for the order")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false, comment: "Identification of the customer"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of the order"),
                    ShippedDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of the shipment"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Identification of the subscription")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false, comment: "Identification of the customer")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgPath = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Path leading to the product's image"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Identification for the category of the product"),
                    OrderId = table.Column<int>(type: "int", nullable: true),
                    SubscriptionBoxId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_SubscriptionBoxes_SubscriptionBoxId",
                        column: x => x.SubscriptionBoxId,
                        principalTable: "SubscriptionBoxes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SubscriptionBoxId",
                table: "Products",
                column: "SubscriptionBoxId");
